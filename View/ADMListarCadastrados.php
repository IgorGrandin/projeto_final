                ...
                <table class="w3-table-all w3-centered">
                    ...
                    <?php
                        ...
                        while($row = $results->fetch_object()) {
                            ...
                            echo '<td style="width: 94%;">'.$row->nome.'</td>';
                            echo '<td style="width: 5%;">
                    <form action="/Controller/Navegacao.php" method="post">
                    <input type="hidden" name="iduser" value="' . $row->idusuario . '">
                    <button name="btnDadosUsuarios" class="w3-button w3-block w3-blue w3-cell w3-round-large">
                    <i class="fa fa-user-circle"></i> </button></td>
                    </form>';
                            echo '</tr>';
                        } 
