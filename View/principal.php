...
<body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-bar-block w3-center w3-blue">
        ...
        <a href="#eProfissional" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-hovertext-cyan w3-text-light-grey">
            <i class="fa fa-users w3-xxlarge"></i>
            <p>Experiência Profissional</p>
        </a>
        <a href="#oFormacoes" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-hovertext-cyan w3-text-light-grey">
